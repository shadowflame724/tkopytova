<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/portfolio')) }}"
                   href="{{ route('admin.portfolio.index') }}">
                    <i class="nav-icon icon-speedometer"></i> Портфолио
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/portfolio-category')) }}"
                   href="{{ route('admin.portfolio-category.index') }}">
                    <i class="nav-icon icon-speedometer"></i> Категории
                </a>
            </li>
